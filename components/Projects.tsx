...
//           <div
//             key={project._id}
//             className="w-screen flex-shrink-0 snap-center flex flex-col items-center justify-center p-6 md:p-44 relative mt-15 md:mt-64 xl:mt-48"
//           >
//             <a
//               href={project?.linkToBuild ? project?.linkToBuild : ""}
//               target="_blank"
    ...
    >
      ...
      >
        {projects?.map((project, i) => (
          <div
            key={project._id}
            className="relative flex justify-center items-center p-6 md:p-44"
          >
            <a
              href={project?.linkToBuild ? project?.linkToBuild : ""}
              target="_blank"
            ...
            <div className="space-y-4 max-w-6xl text-center">
              ...
              <p className="text-xs text-gray-300 h-24 overflow-y-scroll">
                {project.summary}
              </p>
            </div>
          </div>
