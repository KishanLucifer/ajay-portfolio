...
function Projects({ projects }: Props) {
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full overflow-hidden h-full z-20 lg:mt-36">
        <motion.div
        ...
        >
          {projects?.map((project, i) => (
            <div
              key={project._id}
              className="w-full flex-shrink-0 flex flex-col items-center justify-center p-6 md:p-44"
